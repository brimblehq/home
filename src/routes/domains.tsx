      ...
      >
        ...
        <div className="relative">
          ...
          <motion.img
            src={trainStation}
            alt=""
            className="absolute -top-4 right-0 h-[200px] w-auto brightness-[1.02] mix-blend-multiply dark:brightness-100 dark:invert dark:mix-blend-screen dark:opacity-85"
            loading="lazy"
            initial={{ opacity: 0 }}
            animate={isInView ? { opacity: 1 } : {}}
            transition={{
