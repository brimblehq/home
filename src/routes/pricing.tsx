    ...
    <section className="bg-brimble-surface transition-colors duration-300 px-6 pt-16 pb-10">
      ...
      >
        <motion.img
          src={flower}
          alt=""
          className="mb-8 h-[200px] w-[180px] object-cover mix-blend-multiply dark:invert dark:mix-blend-screen dark:opacity-85"
          initial={{ opacity: 0 }}
      ...
      >
        ...
        <div className="relative">
          ...
          <motion.img
            src={trainStation}
            alt=""
            className="absolute -top-4 right-0 h-[200px] w-auto mix-blend-multiply dark:invert dark:mix-blend-screen dark:opacity-85"
            loading="lazy"
            initial={{ opacity: 0 }}
            animate={isInView ? { opacity: 1 } : {}}
            transition={{
