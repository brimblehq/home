...
import { ChevronDown, GitBranch, Settings, Rocket } from "lucide-react";
import balloons from "@/assets/images/balloons.png";

const stepIcons = [GitBranch, Settings, Rocket];
    ...
    <section className="bg-brimble-surface transition-colors duration-300 px-6 py-20">
      <div ref={ref} className="mx-auto flex max-w-[720px] flex-col gap-14">
        ...
        <motion.img
          src={balloons}
          alt=""
          className="mx-auto w-full brightness-[1.02] mix-blend-multiply dark:brightness-100 dark:invert dark:mix-blend-screen dark:opacity-85"
          loading="lazy"
          initial={{ opacity: 0 }}
