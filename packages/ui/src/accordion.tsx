...
function AccordionItem({ className, ...props }: React.ComponentProps<typeof AccordionPrimitive.Item>) {
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        "border-b border-[rgba(152,157,164,0.3)] dark:border-white/10 last:border-b-0 transition-colors duration-200 hover:bg-brimble-air-gray/60 dark:hover:bg-white/5",
        className,
      )}
      {...props}
    />
