...
function ProjectsPage() {
  return (
    <div className="max-w-[1000px]">
      ...
      <hr className="border-dash-border-soft mb-8 -mx-10 -mr-10" />
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div
          className="col-span-2 flex items-center justify-center overflow-clip rounded-[4px] border-[0.5px] border-dash-border"
          style={{
            backgroundImage:
              "repeating-linear-gradient(135deg, transparent, transparent 10px, rgba(217,218,221,0.35) 10px, rgba(217,218,221,0.35) 11px)",
          }}
        >
          <button className="flex items-center gap-2 rounded-lg border border-dash-border bg-dash-bg px-4 py-2 text-sm font-medium text-dash-text-body shadow-sm transition-colors hover:bg-dash-bg-elevated">
