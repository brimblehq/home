...
export function FeaturedIntegrations({ addons, workspace }: { addons: Addon[]; workspace?: string }) {
  return (
    <div className="mb-8">
      <div className="flex items-start justify-between">
        <div>
          <h2 className="text-lg font-semibold text-dash-text-strong">Addons</h2>
          <p className="mt-1 max-w-md text-sm text-dash-text-faded">
            Install one of our recommended options below or browse the addons marketplace.
          </p>
        </div>
