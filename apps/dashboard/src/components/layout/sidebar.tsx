...
export function Sidebar() {
  ...
  return (
    <aside className="sticky top-0 flex h-dvh w-[185px] shrink-0 flex-col border-r border-dash-border-soft bg-dash-bg">
      ...
      <div className="flex flex-col gap-1 px-3 pb-4">
        ...
        <div className="flex min-w-0 items-center gap-2 px-2 py-1.5">
          ...
          />
          <span className="truncate text-sm tracking-[-0.02px] text-dash-text-faded dark:text-dash-text-strong">
            Kemdirim Akujuobi
          </span>
        </div>
        <button
