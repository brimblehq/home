...
export interface PaginatedBucketsResponse extends ApiListResponse<BucketRecord> {}
...
export const createStorageApi = (client: BackendClient) => {
  ...
  return {
    listBuckets: (params?: { projectId?: string; teamId?: string }) => {
      return client.request<any>(basePath, {
        method: "GET",
    ...
    createBucket: (data: { name: string; teamId?: string; region?: string }) => {
      return client.request<any>(basePath, {
        method: "POST",
        body: data,
    ...
    getBucket: (bucketId: string, params?: { teamId?: string }) => {
      return client.request<any>(`${basePath}/${bucketId}`, {
        method: "GET",
        query: params as Record<string, string>,
      }).then(res => res?.data?.data ?? res?.data ?? res);
    },
    ...
    createToken: (bucketId: string, data?: { teamId?: string; name?: string }) => {
      return client.request<any>(`${basePath}/${bucketId}/tokens`, {
        method: "POST",
        body: data,
      }).then(res => res?.data?.data ?? res?.data ?? res);
    },
    ...
    presignDownload: (data: { bucketId: string; path: string; expiresSeconds?: number }) => {
      return client.request<any>(`/core/v1/storage/buckets/${data.bucketId}/user-presign-download`, {
        method: "POST",
        body: data,
      }).then(res => res?.data?.data ?? res?.data ?? res);
    },
    ...
    createUserToken: (bucketId: string, data?: { teamId?: string; name?: string }) => {
      return client.request<any>(`${basePath}/${bucketId}/user-tokens`, {
        method: "POST",
        body: data,
      }).then(res => res?.data?.data ?? res?.data ?? res);
    },
    ...
    listObjects: (bucketId: string, params?: { prefix?: string }) => {
      return client.request<any>(`${basePath}/${bucketId}/objects`, {
        method: "GET",
        query: params as Record<string, string>,
      }).then(res => res?.data?.data ?? res?.data ?? res);
    },
    ...
    listUserObjects: (bucketId: string, params?: { teamId?: string }) => {
      return client.request<any>(`${basePath}/${bucketId}/user-objects`, {
        method: "GET",
        query: params as Record<string, string>,
      }).then(res => res?.data?.data ?? res?.data ?? res);
    },
    ...
    userPresignUpload: (data: { bucketId: string; path: string; contentType?: string; size: number; teamId?: string }) => {
      return client.request<any>(`${basePath}/${data.bucketId}/user-presign-upload`, {
        method: "POST",
        body: data,
    ...
    userMultipartInitiate: (data: { bucketId: string; path: string; contentType?: string; size: number; teamId?: string }) => {
      return client.request<any>(`${basePath}/${data.bucketId}/user-multipart/initiate`, {
        method: "POST",
        body: data,
        query: data.teamId ? { teamId: data.teamId } : undefined,
      }).then(res => res?.data?.data ?? res?.data ?? res);
    ...
    userMultipartPartUrls: (data: { bucketId: string; uploadId: string; totalParts: number; teamId?: string }) => {
      return client.request<any>(`${basePath}/${data.bucketId}/user-multipart/${data.uploadId}/part-urls`, {
        method: "POST",
    ...
    userMultipartComplete: (data: { bucketId: string; uploadId: string; parts: { PartNumber: number, ETag: string }[]; teamId?: string }) => {
      return client.request<any>(`${basePath}/${data.bucketId}/user-multipart/${data.uploadId}/complete`, {
        method: "POST",
    ...
    userMultipartAbort: (data: { bucketId: string; uploadId: string; teamId?: string }) => {
      return client.request<any>(`${basePath}/${data.bucketId}/user-multipart/${data.uploadId}/abort`, {
        method: "DELETE",
        query: data.teamId ? { teamId: data.teamId } : undefined,
      }).then(res => res?.data?.data ?? res?.data ?? res);
    },
